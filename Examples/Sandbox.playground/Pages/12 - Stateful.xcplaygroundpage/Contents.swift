...
func learnStatefulConstruction() {
    ...
    print(increment.eval(5))                                 // () — the Void result
    print(increment.exec(5))                                 // 6  — the new state
    print(increment.runStateful(5))                          // ((), 6) — both

    print(readState.runStateful(42))                         // (42, 42)
    print(double.runStateful(3))                             // ((), 6)
}
...
func learnStatefulGetPutModify() {
    ...
    print(getState.runStateful(42))                          // (42, 42)
    print(putState(100).runStateful(42))                     // ((), 100)
    print(modifyState { $0 * 2 }.runStateful(5))             // ((), 10)
}
...
func learnStatefulMonad() {
    ...
    print((getState >>- step).runStateful(5))                // ("set 10", 10)
}
// learnStatefulMonad()
...
func learnStatefulStack() {
    ...
    print(program.exec([]))                                  // [1, 2, 30]

    let readTop = peek
    print(readTop.eval([10, 20, 30]))                        // Optional(30)
}
// learnStatefulStack()
...
func learnStatefulIdGenerator() {
    ...
    print(allocateThree.runStateful(0))                      // ((0, 1, 2), 3)
}
