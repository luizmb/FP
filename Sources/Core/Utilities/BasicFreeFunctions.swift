...
public extension Of {
    static func ignore() -> (T) -> Void { Core.ignore }
}

public extension Of2 {
    static func ignore() -> (T, U) -> Void { Core.ignore }
}

public extension Of3 {
    static func ignore() -> (T, U, V) -> Void { Core.ignore }
}
