...
public func >>- <A, B>(_ ne: NonEmpty<A?>, _ fn: @escaping @Sendable (A) -> NonEmpty<B?>) -> NonEmpty<B?> {
    ne.flatMapT(fn)
}

/// (-<<) :: (A -> NonEmpty<B?>) -> NonEmpty<A?> -> NonEmpty<B?>
public func -<< <A, B>(_ fn: @escaping @Sendable (A) -> NonEmpty<B?>, _ ne: NonEmpty<A?>) -> NonEmpty<B?> {
    ne.flatMapT(fn)
}
