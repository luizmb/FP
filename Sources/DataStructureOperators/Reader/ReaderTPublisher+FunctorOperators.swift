...
@available(macOS 13.0, iOS 16.0, tvOS 16.0, watchOS 9.0, *)
public func £> <A1: Sendable, A: Sendable, B: Error, Env: Sendable>(_ reader: Reader<Env, any Publisher<A, B>>, _ value: A1)
...
@available(macOS 13.0, iOS 16.0, tvOS 16.0, watchOS 9.0, *)
public func <£ <A1: Sendable, A: Sendable, B: Error, Env: Sendable>(_ value: A1, _ reader: Reader<Env, any Publisher<A, B>>)
-> Reader<Env, any Publisher<A1, B>> {
    reader £> value
}
