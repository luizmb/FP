...
public func >>- <W: Monoid, A, B, E: Error>(_ result: Result<Writer<W, A>, E>, _ fn: @escaping (A) -> Writer<W, B>) -> Result<Writer<W, B>, E> {
    result.flatMapT(fn)
}

// (-<<) :: (a -> Writer<w, b>) -> Result<Writer<w, a>, e> -> Result<Writer<w, b>, e>
public func -<< <W: Monoid, A, B, E: Error>(_ fn: @escaping (A) -> Writer<W, B>, _ result: Result<Writer<W, A>, E>) -> Result<Writer<W, B>, E> {
    result.flatMapT(fn)
}
