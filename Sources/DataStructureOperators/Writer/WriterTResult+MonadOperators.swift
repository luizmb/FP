...
public func >>- <W: Monoid, A, B, E: Error>(_ writer: Writer<W, Result<A, E>>, _ fn: @escaping (A) -> Writer<W, Result<B, E>>) -> Writer<W, Result<B, E>> {
    writer.flatMapT(fn)
}

// (-<<) :: (a -> Writer<w, Result<b, e>>) -> Writer<w, Result<a, e>> -> Writer<w, Result<b, e>>
public func -<< <W: Monoid, A, B, E: Error>(_ fn: @escaping (A) -> Writer<W, Result<B, E>>, _ writer: Writer<W, Result<A, E>>) -> Writer<W, Result<B, E>> {
    writer.flatMapT(fn)
}
