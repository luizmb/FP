...
public func >>- <W: Monoid, S, A, B>(_ writer: Writer<W, Stateful<S, A>>, _ fn: @escaping (A) -> Writer<W, Stateful<S, B>>) -> Writer<W, Stateful<S, B>> {
    writer.flatMapT(fn)
}

// (-<<) :: (a -> Writer<w, Stateful<s, b>>) -> Writer<w, Stateful<s, a>> -> Writer<w, Stateful<s, b>>
public func -<< <W: Monoid, S, A, B>(_ fn: @escaping (A) -> Writer<W, Stateful<S, B>>, _ writer: Writer<W, Stateful<S, A>>) -> Writer<W, Stateful<S, B>> {
    writer.flatMapT(fn)
}
